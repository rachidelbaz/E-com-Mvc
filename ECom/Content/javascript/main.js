...
function updateCarteProducts() {
    var cartProducts;
    var existingsData = $.cookie("CartProducts");
    if (existingsData != null && existingsData != "" && existingsData != undefined) {

        cartProducts = existingsData.split('-');
    }
    else {
        cartProducts = [];
    }
    $("#CatreProductCount").html(cartProducts.length);
}